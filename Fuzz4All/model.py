...
class StarCoder:
    def __init__(
        self, coder_name: str, device: str, eos: List, max_length: int
    ) -> None:
        checkpoint = coder_name
        self.device = device
...
def make_model(eos: List, coder_name: str, device: str, max_length: int):
    """Returns a coder model instance (optional: using the configuration file)."""
    ...
    if "starcoder" in coder_name.lower():
